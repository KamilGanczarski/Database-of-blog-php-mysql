  ...
  <main class='bg-gray'>
    <div class='w-100 mx-0 row justify-content-around'>
      ...
      <div class='col-sm-12 col-lg-8 p-0 mt-3'>
        <?php
          if(isset($_SESSION['search_filter_msg']) && $_SESSION['search_filter_msg'] !== '') {
            echo '<button onclick=\'query_to_PHP("All", "all")\' class="btn btn-sm btn-info mx-2 mb-2">' .
              $_SESSION['search_filter_msg'] .
              '<span aria-hidden="true" class="pl-2">&times;</span>
            </button>';
          } else if(isset($_SESSION['search_filter_msg']) && $_SESSION['search_filter_msg'] !== '') {
            echo '<button onclick=\'query_to_PHP("All", "all")\' class="btn btn-sm btn-info mx-2 mb-2">' .
              $_SESSION['search_filter_msg'] .
              '<span aria-hidden="true" class="pl-2">&times;</span>
            </button>';
